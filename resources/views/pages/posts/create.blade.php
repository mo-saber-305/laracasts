        ...
        <div class="bg-white border-2 border-gray-200 max-w-lg mx-auto px-10 py-8 rounded-lg shadow-xl w-full">
            <div class="max-w-md mx-auto space-y-6">
                ...
                <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <h2 class="text-3xl font-bold text-center">create new post</h2>
                    <hr class="my-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="body" id="body" cols="30" rows="3" placeholder="Enter the body"
                                  class="p-3 mt-2 mb-1 w-full rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none @error('body') border-red-300 @enderror">{{ old('body') }}</textarea>
